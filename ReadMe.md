...
![Fasteners Viewer](https://img.shields.io/badge/status-active-success.svg)
...
Visit the live viewer at: [https://nimageran.github.io/fasteners-viewer/](https://nimageran.github.io/fasteners-viewer/)
...
2. **Create a local tools folder** (separate from this repo)
   ```bash
   mkdir ~/fasteners-tools
   cd ~/fasteners-tools
   ```

3. **Create the catalog generator files**
   ...
   Create `generate-catalog.js` - [Get the code from releases](https://github.com/nimageran/fasteners-viewer/releases)
...
5. **Copy generated files to repository**
   ```bash
...
3. **Copy and push the updated catalog**
   ```bash
   cp catalog.json /path/to/fasteners-viewer/
   cd /path/to/fasteners-viewer/
...
**nimageran**
- GitHub: [@nimageran](https://github.com/nimageran)
- Repository: [fasteners-viewer](https://github.com/nimageran/fasteners-viewer)
